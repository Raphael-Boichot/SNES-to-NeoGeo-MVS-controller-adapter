/*
  ...
  This code was generated by Google Gemini in January 2026 so I guess it plagiarized online sources like
  - https://github.com/robinhedwards/SNES-to-NeoGeo
  - https://github.com/NEO-JAMMA/Neo-Geo_MVS_Projects/tree/main/ControllerAdapter
  - and maybe others as it is quite a simple code overall, so I guess that many sources are available online
  If you feel offended because this code is too similar to yours, human tinkerer, I would be glad to credit your project 
  and I thank you by advance for this very efficient code.
*/
